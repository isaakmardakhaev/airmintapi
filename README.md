...
## Планы
Деплой, веб-клиент на Next.js, мобильный клиент на Jetpack Compose, открытая библиотека папок, а также поддержка различных дополнительных видов блоков информации.
